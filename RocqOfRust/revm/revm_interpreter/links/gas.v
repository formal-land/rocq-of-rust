...
*)
Module MemoryGas.
  RocqOfRustLinkRecord "revm_interpreter::gas::MemoryGas" := {
    expansion_cost : u64;
    words_num : usize
  }.
End MemoryGas.
...
Module MemoryExtensionResult.
  RocqOfRustLinkEnum "revm_interpreter::gas::MemoryExtensionResult" :=
  | Extended
  | Same
  | OutOfGas
  .
...
*)
Module Gas.
  RocqOfRustLinkRecord "revm_interpreter::gas::Gas" := {
    limit : u64;
    memory : MemoryGas.t;
    refunded : i64;
    remaining : u64
