...
Require Import revm.revm_interpreter.instructions.links.contract.extdelegatecall.
...
Lemma extdelegatecall_eq
  ...
  {{
    ...
    (
      Output.Success tt,
      let (interpreter, host) := extdelegatecall interpreter host in
      [interpreter; host]%stack
    )
  }}.
Proof.
