...
Require Import revm.revm_interpreter.instructions.links.contract.extcall.
...
Definition extcall
  ...
  match extcall_gas_calc interpreter host target_address has_transfer with
...
Lemma extcall_eq
  ...
  {{
    ...
    (
      Output.Success tt,
      let (interpreter, host) := extcall interpreter host in
      [interpreter; host]%stack
    )
  }}.
Proof.
