...
Require Import revm.revm_interpreter.instructions.simulate.control.return_inner.
...
Definition revert
  ...
  return_inner interpreter instruction_result.InstructionResult.Revert).
...
Lemma revert_eq
  ...
  {{
    ...
    (
      Output.Success tt,
      [revert interpreter; _host]%stack
    )
  }}.
Proof.
Admitted.
