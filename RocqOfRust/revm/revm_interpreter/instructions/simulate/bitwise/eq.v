...
Lemma op_eq_eq
  ...
  {{
    SimulateM.eval_f
      (run_bitwise_eq run_InterpreterTypes_for_WIRE context)
...
Proof.
  intros.
  with_strategy transparent [run_bitwise_eq] unfold op_eq, run_bitwise_eq; cbn.
