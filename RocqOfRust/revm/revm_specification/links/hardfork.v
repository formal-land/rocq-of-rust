...
Module hardfork.
  ...
  Module Impl_revm_specification_hardfork_SpecId.
    Definition n : PolymorphicFunction.t :=
      fun _ _ _ => M.impossible "revm_specification::hardfork::SpecId::n".

    Definition try_from_u8 : PolymorphicFunction.t :=
      fun _ _ _ => M.impossible "revm_specification::hardfork::SpecId::try_from_u8".

    Definition is_enabled_in : PolymorphicFunction.t :=
      fun _ _ _ => M.impossible "revm_specification::hardfork::SpecId::is_enabled_in".
