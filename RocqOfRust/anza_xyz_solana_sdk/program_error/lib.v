...
Axiom ProgramResult :
  (Ty.path "solana_program_error::ProgramResult") =
    (Ty.apply
    ...
    (M.alloc (|
      ...
      M.call_closure (|
        ...
        [
          ...
          M.read (| get_constant (| "solana_program_error::BUILTIN_BIT_SHIFT", Ty.path "usize" |) |)
        ]
      |)
    |))).
...
Definition value_ACCOUNT_DATA_TOO_SMALL (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ltac:(M.monadic
    (M.alloc (|
      Ty.path "u64",
      M.call_closure (|
...
Definition value_UNINITIALIZED_ACCOUNT (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ltac:(M.monadic
    (M.alloc (|
      Ty.path "u64",
      M.call_closure (|
...
Definition value_ACCOUNT_BORROW_FAILED (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ltac:(M.monadic
    (M.alloc (|
      Ty.path "u64",
      M.call_closure (|
...
Definition value_INVALID_ACCOUNT_OWNER (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ltac:(M.monadic
    (M.alloc (|
      Ty.path "u64",
      M.call_closure (|
...
Axiom IsDiscriminant_ProgramError_Custom :
  M.IsDiscriminant "solana_program_error::ProgramError::Custom" 0.
Axiom IsDiscriminant_ProgramError_InvalidArgument :
  M.IsDiscriminant "solana_program_error::ProgramError::InvalidArgument" 1.
Axiom IsDiscriminant_ProgramError_InvalidInstructionData :
  M.IsDiscriminant "solana_program_error::ProgramError::InvalidInstructionData" 2.
Axiom IsDiscriminant_ProgramError_InvalidAccountData :
  M.IsDiscriminant "solana_program_error::ProgramError::InvalidAccountData" 3.
Axiom IsDiscriminant_ProgramError_AccountDataTooSmall :
  M.IsDiscriminant "solana_program_error::ProgramError::AccountDataTooSmall" 4.
Axiom IsDiscriminant_ProgramError_InsufficientFunds :
  M.IsDiscriminant "solana_program_error::ProgramError::InsufficientFunds" 5.
Axiom IsDiscriminant_ProgramError_IncorrectProgramId :
  M.IsDiscriminant "solana_program_error::ProgramError::IncorrectProgramId" 6.
Axiom IsDiscriminant_ProgramError_MissingRequiredSignature :
  M.IsDiscriminant "solana_program_error::ProgramError::MissingRequiredSignature" 7.
Axiom IsDiscriminant_ProgramError_AccountAlreadyInitialized :
  M.IsDiscriminant "solana_program_error::ProgramError::AccountAlreadyInitialized" 8.
Axiom IsDiscriminant_ProgramError_UninitializedAccount :
  M.IsDiscriminant "solana_program_error::ProgramError::UninitializedAccount" 9.
Axiom IsDiscriminant_ProgramError_NotEnoughAccountKeys :
  M.IsDiscriminant "solana_program_error::ProgramError::NotEnoughAccountKeys" 10.
Axiom IsDiscriminant_ProgramError_AccountBorrowFailed :
  M.IsDiscriminant "solana_program_error::ProgramError::AccountBorrowFailed" 11.
Axiom IsDiscriminant_ProgramError_MaxSeedLengthExceeded :
  M.IsDiscriminant "solana_program_error::ProgramError::MaxSeedLengthExceeded" 12.
Axiom IsDiscriminant_ProgramError_InvalidSeeds :
  M.IsDiscriminant "solana_program_error::ProgramError::InvalidSeeds" 13.
Axiom IsDiscriminant_ProgramError_BorshIoError :
  M.IsDiscriminant "solana_program_error::ProgramError::BorshIoError" 14.
Axiom IsDiscriminant_ProgramError_AccountNotRentExempt :
  M.IsDiscriminant "solana_program_error::ProgramError::AccountNotRentExempt" 15.
Axiom IsDiscriminant_ProgramError_UnsupportedSysvar :
  M.IsDiscriminant "solana_program_error::ProgramError::UnsupportedSysvar" 16.
Axiom IsDiscriminant_ProgramError_IllegalOwner :
  M.IsDiscriminant "solana_program_error::ProgramError::IllegalOwner" 17.
Axiom IsDiscriminant_ProgramError_MaxAccountsDataAllocationsExceeded :
  M.IsDiscriminant "solana_program_error::ProgramError::MaxAccountsDataAllocationsExceeded" 18.
Axiom IsDiscriminant_ProgramError_InvalidRealloc :
  M.IsDiscriminant "solana_program_error::ProgramError::InvalidRealloc" 19.
Axiom IsDiscriminant_ProgramError_MaxInstructionTraceLengthExceeded :
  M.IsDiscriminant "solana_program_error::ProgramError::MaxInstructionTraceLengthExceeded" 20.
Axiom IsDiscriminant_ProgramError_BuiltinProgramsMustConsumeComputeUnits :
  M.IsDiscriminant "solana_program_error::ProgramError::BuiltinProgramsMustConsumeComputeUnits" 21.
Axiom IsDiscriminant_ProgramError_InvalidAccountOwner :
  M.IsDiscriminant "solana_program_error::ProgramError::InvalidAccountOwner" 22.
Axiom IsDiscriminant_ProgramError_ArithmeticOverflow :
  M.IsDiscriminant "solana_program_error::ProgramError::ArithmeticOverflow" 23.
Axiom IsDiscriminant_ProgramError_Immutable :
  M.IsDiscriminant "solana_program_error::ProgramError::Immutable" 24.
Axiom IsDiscriminant_ProgramError_IncorrectAuthority :
  M.IsDiscriminant "solana_program_error::ProgramError::IncorrectAuthority" 25.

Module Impl_core_clone_Clone_for_solana_program_error_ProgramError.
...
End Impl_core_clone_Clone_for_solana_program_error_ProgramError.

Module Impl_core_fmt_Debug_for_solana_program_error_ProgramError.
  Definition Self : Ty.t := Ty.path "solana_program_error::ProgramError".
...
End Impl_core_fmt_Debug_for_solana_program_error_ProgramError.

Module Impl_core_cmp_Eq_for_solana_program_error_ProgramError.
  Definition Self : Ty.t := Ty.path "solana_program_error::ProgramError".
...
End Impl_core_cmp_Eq_for_solana_program_error_ProgramError.

Module Impl_core_marker_StructuralPartialEq_for_solana_program_error_ProgramError.
  Definition Self : Ty.t := Ty.path "solana_program_error::ProgramError".
  ...
  Axiom Implements :
    M.IsTraitInstance
      ...
      Self
      (* Instance *) [].
End Impl_core_marker_StructuralPartialEq_for_solana_program_error_ProgramError.

Module Impl_core_cmp_PartialEq_solana_program_error_ProgramError_for_solana_program_error_ProgramError.
  Definition Self : Ty.t := Ty.path "solana_program_error::ProgramError".
  ...
  Axiom Implements :
    M.IsTraitInstance
      "core::cmp::PartialEq"
      (* Trait polymorphic consts *) []
      (* Trait polymorphic types *) [ Ty.path "solana_program_error::ProgramError" ]
      Self
      (* Instance *) [ ("eq", InstanceField.Method eq) ].
End Impl_core_cmp_PartialEq_solana_program_error_ProgramError_for_solana_program_error_ProgramError.

Module Impl_core_error_Error_for_solana_program_error_ProgramError.
  Definition Self : Ty.t := Ty.path "solana_program_error::ProgramError".
  ...
  Axiom Implements :
    M.IsTraitInstance
      ...
      Self
      (* Instance *) [].
End Impl_core_error_Error_for_solana_program_error_ProgramError.

Module Impl_core_fmt_Display_for_solana_program_error_ProgramError.
  Definition Self : Ty.t := Ty.path "solana_program_error::ProgramError".
  ...
  *)
                  ...
                  [
                    ...
                    M.read (|
                      let~ args :
                        ...
                        Value.Tuple [ M.borrow (| Pointer.Kind.Ref, num |) ] in
                      let~ args :
                          Ty.apply
                            (Ty.path "array")
  ...
  Axiom Implements :
    M.IsTraitInstance
      ...
      Self
      (* Instance *) [ ("fmt", InstanceField.Method fmt) ].
End Impl_core_fmt_Display_for_solana_program_error_ProgramError.

(* Trait *)
(* Empty module 'ToStr' *)

Module Impl_solana_program_error_ProgramError.
  Definition Self : Ty.t := Ty.path "solana_program_error::ProgramError".
...
Module Impl_core_convert_From_solana_program_error_ProgramError_for_u64.
  ...
  *)
  Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ error ] =>
      ltac:(M.monadic
        (let error := M.alloc (| Ty.path "solana_program_error::ProgramError", error |) in
        M.match_operator (|
          Ty.path "u64",
          error,
          [
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::INVALID_ARGUMENT", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::INVALID_INSTRUCTION_DATA", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::INVALID_ACCOUNT_DATA", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::ACCOUNT_DATA_TOO_SMALL", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::INSUFFICIENT_FUNDS", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::INCORRECT_PROGRAM_ID", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
            ...
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::UNINITIALIZED_ACCOUNT", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::NOT_ENOUGH_ACCOUNT_KEYS", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::ACCOUNT_BORROW_FAILED", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::MAX_SEED_LENGTH_EXCEEDED", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  M.is_struct_tuple (| γ, "solana_program_error::ProgramError::InvalidSeeds" |) in
                M.read (|
                  get_constant (| "solana_program_error::INVALID_SEEDS", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  M.is_struct_tuple (| γ, "solana_program_error::ProgramError::BorshIoError" |) in
                M.read (|
                  get_constant (| "solana_program_error::BORSH_IO_ERROR", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::ACCOUNT_NOT_RENT_EXEMPT", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::UNSUPPORTED_SYSVAR", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  M.is_struct_tuple (| γ, "solana_program_error::ProgramError::IllegalOwner" |) in
                M.read (|
                  get_constant (| "solana_program_error::ILLEGAL_OWNER", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
            ...
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::INVALID_ACCOUNT_OWNER", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::ARITHMETIC_OVERFLOW", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  M.is_struct_tuple (| γ, "solana_program_error::ProgramError::Immutable" |) in
                M.read (| get_constant (| "solana_program_error::IMMUTABLE", Ty.path "u64" |) |)));
            fun γ =>
              ltac:(M.monadic
                (let _ :=
                  M.is_struct_tuple (|
                  ...
                  |) in
                M.read (|
                  get_constant (| "solana_program_error::INCORRECT_AUTHORITY", Ty.path "u64" |)
                |)));
            fun γ =>
              ltac:(M.monadic
                (let γ0_0 :=
                  ...
                  [
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        M.read (|
                          get_constant (| "solana_program_error::CUSTOM_ZERO", Ty.path "u64" |)
                        |)));
...
End Impl_core_convert_From_solana_program_error_ProgramError_for_u64.

Module Impl_core_convert_From_u64_for_solana_program_error_ProgramError.
  Definition Self : Ty.t := Ty.path "solana_program_error::ProgramError".
  ...
  *)
  ...
  Axiom Implements :
    M.IsTraitInstance
      ...
      Self
      (* Instance *) [ ("from", InstanceField.Method from) ].
End Impl_core_convert_From_u64_for_solana_program_error_ProgramError.
