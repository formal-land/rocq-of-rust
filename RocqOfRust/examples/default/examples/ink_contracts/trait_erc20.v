            ...
            M.call_closure (|
              ...
              [
                M.value_with_ty
                  ...
                  (Ty.apply (Ty.path "&") [] [ Ty.path "trait_erc20::Error" ])
              ]
            |) in
              ...
              [
                M.value_with_ty
                  (M.borrow (|
                    ...
                    |)
                  |))
                  (Ty.apply (Ty.path "&") [] [ Ty.path "trait_erc20::Env" ])
              ]
            |) in
          let~ _ : Ty.tuple [] :=
            M.call_closure (|
              ...
              [
                ...
                M.value_with_ty (M.read (| caller |)) (Ty.path "trait_erc20::AccountId");
                M.value_with_ty (M.read (| total_supply |)) (Ty.path "u128")
              ]
            |) in
          let~ _ : Ty.tuple [] :=
            M.call_closure (|
                    ...
                    (Value.StructTuple
                      ...
                      [
                        M.value_with_ty
                          ...
                          (Ty.path "trait_erc20::Transfer")
                      ])
                    (Ty.path "trait_erc20::Event"))
                  (Ty.path "trait_erc20::Event")
              ]
            |) in
          M.alloc (|
              ...
              let~ from_balance : Ty.path "u128" :=
                M.call_closure (|
                  ...
                  [
                    M.value_with_ty
                      (M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| self |) |) |))
                      (Ty.apply (Ty.path "&") [] [ Ty.path "trait_erc20::Erc20" ]);
                    M.value_with_ty
        ...
        M.call_closure (|
          ...
          [
            ...
            M.value_with_ty
              (M.borrow (|
                Pointer.Kind.Ref,
                M.deref (| M.borrow (| Pointer.Kind.Ref, spender |) |)
              |))
              (Ty.apply (Ty.path "&") [] [ Ty.path "trait_erc20::AccountId" ])
          ]
        |)))
            ...
            M.call_closure (|
              ...
              [
                M.value_with_ty
                  ...
                  (Ty.apply (Ty.path "&mut") [] [ Ty.path "trait_erc20::Erc20" ]);
                M.value_with_ty
                  (M.borrow (|
                    Pointer.Kind.Ref,
