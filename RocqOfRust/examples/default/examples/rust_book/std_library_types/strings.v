            ...
            [
              M.value_with_ty
                (M.borrow (|
                  ...
                  |)
                |))
                (Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "slice") [] [ Ty.path "char" ] ])
            ]
          |) in
        let~ _ : Ty.tuple [] :=
          M.call_closure (|
                                        ...
                                        [
                                          M.value_with_ty
                                            (M.borrow (|
                                              Pointer.Kind.Ref,
                                              M.deref (|
                                                M.borrow (| Pointer.Kind.Ref, trimmed_str |)
                                              |)
                                            |))
                                            (Ty.apply
                                              (Ty.path "&")
          ...
          M.call_closure (|
            ...
            [
              M.value_with_ty
                ...
                |))
                (Ty.apply (Ty.path "&") [] [ Ty.path "str" ]);
              M.value_with_ty (mk_str (| "dog" |)) (Ty.apply (Ty.path "&") [] [ Ty.path "str" ]);
              M.value_with_ty
