                      ...
                      M.call_closure (|
                        ...
                        [
                          M.value_with_ty
                            ...
                            (Ty.apply (Ty.path "&") [] [ Ty.path "traits::Sheep" ])
                        ]
                      |)
                    |)) in
        ...
        let~ dolly : Ty.path "traits::Sheep" :=
          M.call_closure (|
            ...
            M.get_trait_method (|
              ...
              []
            |),
            [ M.value_with_ty (mk_str (| "Dolly" |)) (Ty.apply (Ty.path "&") [] [ Ty.path "str" ]) ]
          |) in
        let~ _ : Ty.tuple [] :=
          M.call_closure (|
            Ty.tuple [],
          ...
          M.call_closure (|
            ...
            [
              M.value_with_ty
                ...
                (Ty.apply (Ty.path "&mut") [] [ Ty.path "traits::Sheep" ])
            ]
          |) in
        let~ _ : Ty.tuple [] :=
          M.call_closure (|
