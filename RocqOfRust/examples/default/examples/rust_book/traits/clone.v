...
Definition main (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ...
  | [], [], [] =>
    ltac:(M.monadic
      (M.read (|
        let~ unit_ : Ty.path "clone::Unit" :=
          M.value_with_ty (Value.StructTuple "clone::Unit" []) (Ty.path "clone::Unit") in
                                      ...
                                      M.call_closure (|
                                        ...
                                        [
                                          M.value_with_ty
                                            ...
                                            |))
                                            (Ty.apply (Ty.path "&") [] [ Ty.path "clone::Unit" ])
                                        ]
                                      |)
                                    ]
                                |)
                                        ...
                                        [
                                          M.value_with_ty
                                            (M.borrow (|
                                              Pointer.Kind.Ref,
                                              M.deref (|
                                                M.borrow (| Pointer.Kind.Ref, copied_unit |)
                                              |)
                                            |))
                                            (Ty.apply (Ty.path "&") [] [ Ty.path "clone::Unit" ])
                                        ]
                                      ...
                                      M.call_closure (|
                                        ...
                                        [
                                          M.value_with_ty
                                            ...
                                            |))
                                            (Ty.apply (Ty.path "&") [] [ Ty.path "clone::Pair" ])
                                        ]
                                      |)
                                    ]
                                |)
...
" |) ]
        ...
        let~ _ : Ty.tuple [] :=
          M.call_closure (|
            ...
            [ M.value_with_ty (M.read (| moved_pair |)) (Ty.path "clone::Pair") ]
          |) in
        let~ _ : Ty.tuple [] :=
          M.read (|
            let~ _ : Ty.tuple [] :=
                                        ...
                                        [
                                          M.value_with_ty
                                            (M.borrow (|
                                              Pointer.Kind.Ref,
                                              M.deref (|
                                                M.borrow (| Pointer.Kind.Ref, cloned_pair |)
                                              |)
                                            |))
                                            (Ty.apply (Ty.path "&") [] [ Ty.path "clone::Pair" ])
                                        ]
