        ...
        let~ name : Ty.path "alloc::string::String" :=
          M.call_closure (|
            ...
            M.get_trait_method (|
              ...
              []
            |),
            [ M.value_with_ty (mk_str (| "Peter" |)) (Ty.apply (Ty.path "&") [] [ Ty.path "str" ]) ]
          |) in
