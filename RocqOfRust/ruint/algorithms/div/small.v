                ...
                (M.read (|
                  ...
                  let~ shift : Ty.path "u32" :=
                    M.call_closure (|
                      ...
                      [ M.value_with_ty (M.read (| divisor |)) (Ty.path "u64") ]
                    |) in
                  let~ _ : Ty.tuple [] :=
                    M.match_operator (|
                      Ty.tuple [],
                  ...
                  let~ n : Ty.path "u128" :=
                    M.call_closure (|
                      ...
                      |),
                      [
                        M.value_with_ty (M.read (| remainder |)) (Ty.path "u64");
                        M.value_with_ty
                          (M.call_closure (|
                            Ty.path "u64",
                            BinOp.Wrap.shl,
                      ...
                      M.alloc (|
                        ...
                        M.call_closure (|
                          ...
                          [
                            ...
                            M.value_with_ty (M.read (| divisor |)) (Ty.path "u64");
                            M.value_with_ty (M.read (| reciprocal |)) (Ty.path "u64")
                          ]
                        |)
                      |),
                      [
                        ...
                        M.value_with_ty
                          (M.call_closure (|
                            ...
                            M.get_trait_method (|
                              ...
                              []
                            |),
                            [ M.value_with_ty (M.read (| divisor |)) (Ty.path "u128") ]
                          |))
                          (Ty.path "u64")
                      ]
                    |) in
                    ...
                    M.match_operator (|
                      ...
                      M.alloc (|
                        ...
                        M.call_closure (|
                          ...
                          |),
                          [
                            M.value_with_ty (M.read (| remainder |)) (Ty.path "u128");
                            M.value_with_ty
                              (M.call_closure (|
                                Ty.path "u64",
                                BinOp.Wrap.shl,
            ...
            M.read (|
              ...
              let~ r : Ty.path "u64" :=
                M.call_closure (|
                  ...
                  [
                    M.value_with_ty (M.cast (Ty.path "u64") (M.read (| u |))) (Ty.path "u64");
                    M.value_with_ty
                      (M.call_closure (|
                        Ty.path "u64",
                        M.get_associated_function (| Ty.path "u64", "wrapping_mul", [], [] |),
                        [
                          M.value_with_ty (M.read (| q1 |)) (Ty.path "u64");
                          M.value_with_ty (M.read (| d |)) (Ty.path "u64")
                        ]
                      |))
                      (Ty.path "u64")
                            ...
                            Value.Tuple
                              [
                                ...
                                M.call_closure (|
                                  ...
                                  |),
                                  [
                                    M.value_with_ty (M.read (| r |)) (Ty.path "u64");
                                    M.value_with_ty (M.read (| d |)) (Ty.path "u64")
                                  ]
                                |)
                              ]));
                                    ...
                                    [
                                        ...
                                        [
                                          M.call_closure (|
                                            ...
                                            M.get_trait_method (|
                                              ...
                                              []
                                            |),
                                            [ M.value_with_ty (M.read (| n1 |)) (Ty.path "u64") ]
                                          |);
                                          Value.Integer IntegerKind.I32 64
                                        ]
                                      |);
                                      M.call_closure (|
                                        ...
                                        M.get_trait_method (|
                                          ...
                                          []
                                        |),
                                        [ M.value_with_ty (M.read (| n0 |)) (Ty.path "u64") ]
                                      |)
                                    ]
                                  |))
                                  (Ty.path "u128")
                        ...
                        (M.match_operator (|
                          ...
                          M.alloc (|
                            ...
                            M.call_closure (|
                              ...
                              |),
                              [
                                M.value_with_ty (M.read (| n21 |)) (Ty.path "u128");
                          ...
                          [
                            fun γ =>
                              ltac:(M.monadic
                                ...
                                let~ r : Ty.path "u64" := M.read (| γ0_1 |) in
                                M.read (|
                                  let~ t1 : Ty.path "u128" :=
                                    M.call_closure (|
                                      Ty.path "u128",
                                      ...
                                      [
                                        M.call_closure (|
                                          ...
                                          M.get_trait_method (|
                                            ...
                                            []
                                          |),
                                          [ M.value_with_ty (M.read (| q |)) (Ty.path "u64") ]
                                        |);
                                        M.call_closure (|
                                          Ty.path "u128",
                                          M.get_trait_method (|
                        ...
                        M.value_with_ty
                          (M.call_closure (|
                            ...
                            M.get_trait_method (|
                              ...
                              []
                            |),
                            [ M.value_with_ty (M.read (| u21 |)) (Ty.path "u128") ]
                          |))
                          (Ty.path "u64");
                        M.value_with_ty (M.read (| v |)) (Ty.path "u64")
                      ]
                          ...
                          M.value_with_ty
                            (M.call_closure (|
                              ...
                              M.get_trait_method (|
                                ...
                                []
                              |),
                              [ M.value_with_ty (M.read (| q |)) (Ty.path "u128") ]
                            |))
                            (Ty.path "u64");
                          M.value_with_ty
                            (M.call_closure (|
                        ...
                        [
                          M.value_with_ty
                            (M.call_closure (|
                              ...
                              |),
                              [
                                M.value_with_ty (M.read (| r1 |)) (Ty.path "u64");
                                M.value_with_ty (M.read (| u0 |)) (Ty.path "u64")
                              ]
                            |))
                            (Ty.path "u128");
                                ...
                                [
                                  M.call_closure (|
                                    ...
                                    M.get_trait_method (|
                                      ...
                                      []
                                    |),
                                    [ M.value_with_ty (M.read (| r |)) (Ty.path "u128") ]
                                  |);
                                  M.call_closure (|
                                    Ty.path "u64",
                                    M.get_trait_method (|
