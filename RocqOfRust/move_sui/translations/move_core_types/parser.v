                                      ...
                                      [
                                        M.call_closure (|
                                          ...
                                          M.get_associated_function (|
                                            ...
                                            []
                                          |),
                                          [ mk_str (| "out of tokens, this should not happen" |) ]
                                        |)
                                      ]
                                    |) in
                                  error
                                              ...
                                              [
                                                M.read (|
                                                  let~ args :
                                                    ...
                                                    Value.Tuple
                                                      [ M.borrow (| Pointer.Kind.Ref, tok |) ] in
                                                  let~ args :
                                                      Ty.apply
                                                        (Ty.path "array")
                                                        [ Value.Integer IntegerKind.Usize 1 ]
                                            ...
                                            [
                                              M.read (|
                                                let~ args :
                                                  ...
                                                  Value.Tuple
                                                    [ M.borrow (| Pointer.Kind.Ref, s |) ] in
                                                let~ args :
                                                    Ty.apply
                                                      (Ty.path "array")
                                                      [ Value.Integer IntegerKind.Usize 1 ]
