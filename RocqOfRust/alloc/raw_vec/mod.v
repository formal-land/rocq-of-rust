...
Module raw_vec.
  ...
  *)
  ...
  Axiom Cap : (Ty.path "alloc::raw_vec::Cap") = (Ty.path "core::num::niche_types::UsizeNoHighBit").
  
  Definition value_ZERO_CAP (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ltac:(M.monadic
      (M.alloc (|
  ...
  *)
  Definition new_cap (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    match ε, τ, α with
    | [], [ T ], [ cap ] =>
      ltac:(M.monadic
  ...
  (* StructRecord
    {
      ...
      fields :=
        [
          ...
          ("cap", Ty.path "core::num::niche_types::UsizeNoHighBit");
          ("alloc", A)
        ];
    } *)
  ...
  *)
    ...
    Definition new_in (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ alloc ] =>
        ltac:(M.monadic
          ...
          M.read (|
            let~ _ : Ty.tuple [] :=
              M.read (| get_constant (| "alloc::raw_vec::new_in_discriminant", Ty.tuple [] |) |) in
            M.alloc (|
          ...
          M.read (|
            let~ ptr : Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ] :=
              M.call_closure (|
                ...
                [ M.read (| ptr |) ]
              |) in
            let~ capacity : Ty.path "core::num::niche_types::UsizeNoHighBit" :=
              M.call_closure (|
                Ty.path "core::num::niche_types::UsizeNoHighBit",
                M.get_function (| "alloc::raw_vec::new_cap", [], [ T ] |),
                [ M.read (| capacity |) ]
              |) in
            M.alloc (|
              Ty.apply (Ty.path "alloc::raw_vec::RawVec") [] [ T; A ],
  ...
  Module Impl_alloc_raw_vec_RawVecInner_A.
    ...
    Definition from_raw_parts_in
      ...
      | [], [], [ ptr; cap; alloc ] =>
        ltac:(M.monadic
          ...
          let cap := M.alloc (| Ty.path "core::num::niche_types::UsizeNoHighBit", cap |) in
          let alloc := M.alloc (| A, alloc |) in
          Value.mkStructRecord
            "alloc::raw_vec::RawVecInner"
            []
    ...
    *)
    Definition finish_grow (A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      let Self : Ty.t := Self A in
      match ε, τ, α with
      | [], [], [ self; cap; elem_layout ] =>
        ltac:(M.monadic
