...
Module collections.
  Module vec_deque.
    Module extract_if.
      ...
      Module Impl_alloc_collections_vec_deque_extract_if_ExtractIf_T_F_A.
        Definition Self (T F A : Ty.t) : Ty.t :=
          Ty.apply (Ty.path "alloc::collections::vec_deque::extract_if::ExtractIf") [] [ T; F; A ].
          ...
          | [], [ R ], [ vec; pred; range ] =>
            ltac:(M.monadic
              ...
              M.read (|
                ...
                M.alloc (|
                  Ty.apply
                    (Ty.path "alloc::collections::vec_deque::extract_if::ExtractIf")
                    []
                    [ T; F; A ],
                  M.match_operator (|
                    Ty.apply
                          ...
                          M.read (|
                            ...
                            M.alloc (|
                              Ty.apply
                                ...
                                [ T; F; A ],
                              Value.mkStructRecord
                                "alloc::collections::vec_deque::extract_if::ExtractIf"
                                []
                                [ T; F; A ]
                                [
                                  ("vec",
      ...
      Module Impl_core_iter_traits_iterator_Iterator_where_core_alloc_Allocator_A_where_core_ops_function_FnMut_F_Tuple_ref_mut_T__for_alloc_collections_vec_deque_extract_if_ExtractIf_T_F_A.
        Definition Self (T F A : Ty.t) : Ty.t :=
          Ty.apply (Ty.path "alloc::collections::vec_deque::extract_if::ExtractIf") [] [ T; F; A ].
      ...
      End Impl_core_iter_traits_iterator_Iterator_where_core_alloc_Allocator_A_where_core_ops_function_FnMut_F_Tuple_ref_mut_T__for_alloc_collections_vec_deque_extract_if_ExtractIf_T_F_A.
      
      Module Impl_core_ops_drop_Drop_where_core_alloc_Allocator_A_for_alloc_collections_vec_deque_extract_if_ExtractIf_T_F_A.
        Definition Self (T F A : Ty.t) : Ty.t :=
          Ty.apply (Ty.path "alloc::collections::vec_deque::extract_if::ExtractIf") [] [ T; F; A ].
      ...
      End Impl_core_ops_drop_Drop_where_core_alloc_Allocator_A_for_alloc_collections_vec_deque_extract_if_ExtractIf_T_F_A.
      
      Module Impl_core_fmt_Debug_where_core_fmt_Debug_T_where_core_alloc_Allocator_A_for_alloc_collections_vec_deque_extract_if_ExtractIf_T_F_A.
        Definition Self (T F A : Ty.t) : Ty.t :=
          Ty.apply (Ty.path "alloc::collections::vec_deque::extract_if::ExtractIf") [] [ T; F; A ].
      ...
      End Impl_core_fmt_Debug_where_core_fmt_Debug_T_where_core_alloc_Allocator_A_for_alloc_collections_vec_deque_extract_if_ExtractIf_T_F_A.
    End extract_if.
  End vec_deque.
End collections.
