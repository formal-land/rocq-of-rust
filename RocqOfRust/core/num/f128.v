          ...
          M.call_closure (|
            ...
            [
              M.call_closure (|
                ...
                [ M.value_with_ty (M.read (| self |)) (Ty.path "f128") ]
              |);
              ...
              (M.read (|
                ...
                M.alloc (|
                  ...
                  M.call_closure (|
                    ...
                    [ M.value_with_ty (M.read (| next_bits |)) (Ty.path "u128") ]
                  |)
                |)
              |)))
          |)))
      ...
      | [], [], [ self; other ] =>
        ltac:(M.monadic
          ...
          M.call_closure (|
            ...
            [
              M.value_with_ty (M.read (| self |)) (Ty.path "f128");
              M.value_with_ty (M.read (| other |)) (Ty.path "f128")
            ]
          |)))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
                  ...
                  M.read (|
                    let~ abs_a : Ty.path "f128" :=
                      M.call_closure (|
                        Ty.path "f128",
                        M.get_associated_function (| Ty.path "f128", "abs", [], [] |),
                        [ M.value_with_ty (M.read (| a |)) (Ty.path "f128") ]
                      |) in
                    let~ abs_b : Ty.path "f128" :=
                      M.call_closure (|
                        Ty.path "f128",
                        M.get_associated_function (| Ty.path "f128", "abs", [], [] |),
                        [ M.value_with_ty (M.read (| b |)) (Ty.path "f128") ]
                      |) in
                    M.alloc (|
                      Ty.path "f128",
                      M.match_operator (|
      ...
      | [], [], [ v ] =>
        ltac:(M.monadic
          ...
          M.call_closure (|
            ...
            |),
            [ M.value_with_ty (M.read (| v |)) (Ty.path "u128") ]
          |)))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
            ...
            let~ left : Ty.path "i128" :=
              M.cast
                ...
                (M.call_closure (|
                  Ty.path "u128",
                  M.get_associated_function (| Ty.path "f128", "to_bits", [], [] |),
                  [ M.value_with_ty (M.read (| M.deref (| M.read (| self |) |) |)) (Ty.path "f128")
                  ]
                |)) in
            let~ right : Ty.path "i128" :=
              M.cast
                ...
                (M.call_closure (|
                  Ty.path "u128",
                  M.get_associated_function (| Ty.path "f128", "to_bits", [], [] |),
                  [ M.value_with_ty (M.read (| M.deref (| M.read (| other |) |) |)) (Ty.path "f128")
                  ]
                |)) in
            let~ _ : Ty.tuple [] :=
              let β := left in
                    ...
                    ltac:(M.monadic
                      ...
                      M.never_to_any (|
                        M.call_closure (|
                          ...
                          [
                            M.value_with_ty (M.read (| min |)) (Ty.path "f128");
                            M.value_with_ty (M.read (| max |)) (Ty.path "f128")
                          ]
                        |)
                      |)));
                  fun γ => ltac:(M.monadic (Value.Tuple []))
              ...
              fun γ =>
                ltac:(M.monadic
                  (M.call_closure (|
                    ...
                    [
                      M.value_with_ty (M.read (| UnsupportedLiteral |)) (Ty.path "f128");
                      M.value_with_ty (M.read (| self |)) (Ty.path "f128")
                    ]
                  |)))
            ]
      ...
      | [], [], [ self; sign ] =>
        ltac:(M.monadic
          ...
          M.call_closure (|
            ...
            [
              M.value_with_ty (M.read (| self |)) (Ty.path "f128");
              M.value_with_ty (M.read (| sign |)) (Ty.path "f128")
            ]
          |)))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
