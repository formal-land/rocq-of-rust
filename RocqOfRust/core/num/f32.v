              ...
              (M.read (|
                ...
                M.alloc (|
                  ...
                  M.call_closure (|
                    ...
                    [ M.value_with_ty (M.read (| next_bits |)) (Ty.path "u32") ]
                  |)
                |)
              |)))
          |)))
      ...
      | [], [], [ self; other ] =>
        ltac:(M.monadic
          ...
          M.call_closure (|
            ...
            [
              M.value_with_ty (M.read (| self |)) (Ty.path "f32");
              M.value_with_ty (M.read (| other |)) (Ty.path "f32")
            ]
          |)))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
            ...
            let~ left : Ty.path "i32" :=
              M.cast
                ...
                (M.call_closure (|
                  Ty.path "u32",
                  M.get_associated_function (| Ty.path "f32", "to_bits", [], [] |),
                  [ M.value_with_ty (M.read (| M.deref (| M.read (| self |) |) |)) (Ty.path "f32") ]
                |)) in
            let~ right : Ty.path "i32" :=
              M.cast
                ...
                (M.call_closure (|
                  Ty.path "u32",
                  M.get_associated_function (| Ty.path "f32", "to_bits", [], [] |),
                  [ M.value_with_ty (M.read (| M.deref (| M.read (| other |) |) |)) (Ty.path "f32")
                  ]
                |)) in
            let~ _ : Ty.tuple [] :=
              let β := left in
                    ...
                    ltac:(M.monadic
                      ...
                      M.never_to_any (|
                        M.call_closure (|
                          ...
                          [
                            M.value_with_ty (M.read (| min |)) (Ty.path "f32");
                            M.value_with_ty (M.read (| max |)) (Ty.path "f32")
                          ]
                        |)
                      |)));
                  fun γ => ltac:(M.monadic (Value.Tuple []))
      ...
      | [], [], [ self; sign ] =>
        ltac:(M.monadic
          ...
          M.call_closure (|
            ...
            [
              M.value_with_ty (M.read (| self |)) (Ty.path "f32");
              M.value_with_ty (M.read (| sign |)) (Ty.path "f32")
            ]
          |)))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
