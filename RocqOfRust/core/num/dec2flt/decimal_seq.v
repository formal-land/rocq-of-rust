...
Module num.
  Module dec2flt.
    Module decimal_seq.
            ...
            [
              ...
              ("digits",
                Ty.apply
                  ...
                  [
                    M.unevaluated_const
                      (mk_str (| "core_num_dec2flt_decimal_seq_DecimalSeq_digits_discriminant" |))
                  ]
                  [ Ty.path "u8" ])
            ];
        } *)
      
      Module Impl_core_clone_Clone_for_core_num_dec2flt_decimal_seq_DecimalSeq.
        Definition Self : Ty.t := Ty.path "core::num::dec2flt::decimal_seq::DecimalSeq".
              ...
              (let self :=
                M.alloc (|
                  Ty.apply
                    (Ty.path "&")
                    []
                    [ Ty.path "core::num::dec2flt::decimal_seq::DecimalSeq" ],
                  self
                |) in
      ...
      End Impl_core_clone_Clone_for_core_num_dec2flt_decimal_seq_DecimalSeq.
      
      Module Impl_core_fmt_Debug_for_core_num_dec2flt_decimal_seq_DecimalSeq.
        Definition Self : Ty.t := Ty.path "core::num::dec2flt::decimal_seq::DecimalSeq".
            ...
            ltac:(M.monadic
              ...
              M.call_closure (|
                ...
                [
                  ...
                  M.borrow (| Pointer.Kind.Ref, M.deref (| mk_str (| "DecimalSeq" |) |) |);
                  M.borrow (| Pointer.Kind.Ref, M.deref (| mk_str (| "num_digits" |) |) |);
                  M.call_closure (|
                  ...
                  |);
                  M.borrow (| Pointer.Kind.Ref, M.deref (| mk_str (| "decimal_point" |) |) |);
                  M.call_closure (|
                    Ty.apply (Ty.path "&") [] [ Ty.dyn [ ("core::fmt::Debug::Trait", []) ] ],
                    M.pointer_coercion
                      M.PointerCoercion.Unsize
                  ...
                  |);
                  M.borrow (| Pointer.Kind.Ref, M.deref (| mk_str (| "digits" |) |) |);
                  M.call_closure (|
                    Ty.apply (Ty.path "&") [] [ Ty.dyn [ ("core::fmt::Debug::Trait", []) ] ],
                    M.pointer_coercion
                      M.PointerCoercion.Unsize
      ...
      End Impl_core_fmt_Debug_for_core_num_dec2flt_decimal_seq_DecimalSeq.
      
      Module Impl_core_marker_StructuralPartialEq_for_core_num_dec2flt_decimal_seq_DecimalSeq.
        Definition Self : Ty.t := Ty.path "core::num::dec2flt::decimal_seq::DecimalSeq".
        ...
        Axiom Implements :
          M.IsTraitInstance
            ...
            Self
            (* Instance *) [].
      End Impl_core_marker_StructuralPartialEq_for_core_num_dec2flt_decimal_seq_DecimalSeq.
      
      Module Impl_core_cmp_PartialEq_core_num_dec2flt_decimal_seq_DecimalSeq_for_core_num_dec2flt_decimal_seq_DecimalSeq.
        Definition Self : Ty.t := Ty.path "core::num::dec2flt::decimal_seq::DecimalSeq".
        ...
        Axiom Implements :
          M.IsTraitInstance
            "core::cmp::PartialEq"
            (* Trait polymorphic consts *) []
            (* Trait polymorphic types *) [ Ty.path "core::num::dec2flt::decimal_seq::DecimalSeq" ]
            Self
            (* Instance *) [ ("eq", InstanceField.Method eq) ].
      End Impl_core_cmp_PartialEq_core_num_dec2flt_decimal_seq_DecimalSeq_for_core_num_dec2flt_decimal_seq_DecimalSeq.
      
      Module Impl_core_default_Default_for_core_num_dec2flt_decimal_seq_DecimalSeq.
        Definition Self : Ty.t := Ty.path "core::num::dec2flt::decimal_seq::DecimalSeq".
      ...
      End Impl_core_default_Default_for_core_num_dec2flt_decimal_seq_DecimalSeq.
      
      Module Impl_core_num_dec2flt_decimal_seq_DecimalSeq.
        Definition Self : Ty.t := Ty.path "core::num::dec2flt::decimal_seq::DecimalSeq".
      ...
      *)
      Definition parse_decimal_seq (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        match ε, τ, α with
        | [], [], [ s ] =>
          ltac:(M.monadic
            (let s :=
              ...
              |) in
            M.read (|
              let~ d : Ty.path "core::num::dec2flt::decimal_seq::DecimalSeq" :=
                M.call_closure (|
                  Ty.path "core::num::dec2flt::decimal_seq::DecimalSeq",
                  M.get_trait_method (|
                    "core::default::Default",
      ...
      Definition number_of_digits_decimal_left_shift
        ...
        | [], [], [ d; shift ] =>
          ltac:(M.monadic
            (let d :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "core::num::dec2flt::decimal_seq::DecimalSeq" ],
                d
              |) in
            let shift := M.alloc (| Ty.path "usize", shift |) in
