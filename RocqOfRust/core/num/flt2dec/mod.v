...
Module num.
  Module flt2dec.
                                ...
                                fun γ =>
                                  ltac:(M.monadic
                                    ...
                                    M.call_closure (|
                                      Ty.path "bool",
                                      BinOp.ne,
                                      [ M.read (| c |); Value.Integer IntegerKind.U8 57 ]
                                    |)))
                              ]
                            |)))
                          ...
                          M.borrow (|
                            ...
                            M.deref (|
                              M.call_closure (|
                                ...
                                |),
                                [
                                  M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| d |) |) |);
                                  ...
                                  [
                                    M.call_closure (|
                                      ...
                                      [
                                        M.borrow (|
                                          Pointer.Kind.Ref,
                                          M.deref (| M.mk_byte_str_ref 2 [ 48; 46 ] |)
                                        |)
                                      ]
                                    |)
                                  ]
                                              ...
                                              [
                                                M.call_closure (|
                                                  ...
                                                  [
                                                    M.borrow (|
                                                      Pointer.Kind.Ref,
                                                      M.deref (| M.mk_byte_str_ref 1 [ 46 ] |)
                                                    |)
                                                  ]
                                                |)
                                              ]
                                          ...
                                          ltac:(M.monadic
                                            ...
                                            M.call_closure (|
                                              ...
                                              [
                                                M.borrow (|
                                                  Pointer.Kind.Ref,
                                                  M.deref (| M.mk_byte_str_ref 2 [ 69; 45 ] |)
                                                |)
                                              ]
                                            |)));
                                        fun γ =>
                                          ltac:(M.monadic
                                            (M.call_closure (|
                                              ...
                                              [
                                                M.borrow (|
                                                  Pointer.Kind.Ref,
                                                  M.deref (| M.mk_byte_str_ref 2 [ 101; 45 ] |)
                                                |)
                                              ]
                                            |)))
                                      ]
                                          ...
                                          ltac:(M.monadic
                                            ...
                                            M.call_closure (|
                                              ...
                                              [
                                                M.borrow (|
                                                  Pointer.Kind.Ref,
                                                  M.deref (| M.mk_byte_str_ref 1 [ 69 ] |)
                                                |)
                                              ]
                                            |)));
                                        fun γ =>
                                          ltac:(M.monadic
                                            (M.call_closure (|
                                              ...
                                              [
                                                M.borrow (|
                                                  Pointer.Kind.Ref,
                                                  M.deref (| M.mk_byte_str_ref 1 [ 101 ] |)
                                                |)
                                              ]
                                            |)))
                                      ]
    ...
    *)
    ...
    Module Impl_core_clone_TrivialClone_for_core_num_flt2dec_Sign.
      Definition Self : Ty.t := Ty.path "core::num::flt2dec::Sign".
      ...
      Axiom Implements :
        M.IsTraitInstance
          ...
          Self
          (* Instance *) [].
    End Impl_core_clone_TrivialClone_for_core_num_flt2dec_Sign.
                                                ...
                                                M.call_closure (|
                                                  ...
                                                  [
                                                    M.borrow (|
                                                      Pointer.Kind.Ref,
                                                      M.deref (|
                                                        M.mk_byte_str_ref 3 [ 105; 110; 102 ]
                                                      |)
                                                    |)
                                                  ]
                                                |)
