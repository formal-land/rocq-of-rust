            ...
            M.call_closure (|
              ...
              [
                ...
                M.value_with_ty
                  ...
                  (Ty.function [ Ty.path "u32" ] (Ty.path "char"))
              ]
            |)))
        | _, _, _ => M.impossible "wrong number of arguments"
        end.
                                ...
                                M.value_with_ty
                                  (M.call_closure (|
                                    ...
                                    [
                                      ...
                                      M.value_with_ty (M.read (| bytes_skipped |)) (Ty.path "usize")
                                    ]
                                  |))
                                  (Ty.apply
                                    (Ty.path "core::result::Result")
                                        ...
                                        M.value_with_ty
                                          (M.call_closure (|
                                            ...
                                            [
                                              ...
                                              M.value_with_ty (M.read (| slurp |)) (Ty.path "usize")
                                            ]
                                          |))
                                          (Ty.apply
                                            (Ty.path "core::result::Result")
                    ...
                    M.value_with_ty
                      (M.call_closure (|
                        ...
                        M.get_associated_function (|
                          ...
                          []
                        |),
                        [ M.value_with_ty (M.read (| remainder |)) (Ty.path "usize") ]
                      |))
                      (Ty.apply
                        (Ty.path "core::option::Option")
                        []
                            ...
                            (M.call_closure (|
                              ...
                              M.pointer_coercion
                                ...
                                (Ty.apply
                                  ...
                                  [
                                    Ty.apply
                                      (Ty.path "core::str::iter::MatchIndicesInternal")
                                      []
                                      [ P ]
                                  ])
                                (Ty.apply
            ...
            M.call_closure (|
              ...
              [
                ...
                M.value_with_ty
                  (M.borrow (|
                    Pointer.Kind.Ref,
                    M.deref (| mk_str (| "SplitAsciiWhitespace" |) |)
                  |))
                  (Ty.apply (Ty.path "&") [] [ Ty.path "str" ]);
                M.value_with_ty
                  (M.borrow (| Pointer.Kind.Ref, M.deref (| mk_str (| "inner" |) |) |))
                    ...
                    M.call_closure (|
                      ...
                      [
                        ...
                        M.value_with_ty
                          ...
                          (Ty.function [ Ty.path "char" ] (Ty.path "u16"))
                      ]
                    |)
                  |)
                |)))
