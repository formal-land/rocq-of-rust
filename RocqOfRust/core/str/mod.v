                    ...
                    M.call_closure (|
                      ...
                      [
                        ...
                        M.call_closure (|
                          ...
                          [ M.value_with_ty (M.read (| ch |)) (Ty.path "char") ]
                        |)
                      ]
                    |))
                ])
                      ...
                      M.call_closure (|
                        ...
                        [
                          M.value_with_ty
                            ...
                            |))
                            (Ty.apply (Ty.path "core::option::Option") [] [ Ty.path "usize" ]);
                          M.value_with_ty (M.read (| upper_bound |)) (Ty.path "usize");
                          M.value_with_ty
                            (M.closure
                              (fun γ =>
                                ltac:(M.monadic
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          ...
          M.call_closure (|
            ...
            |),
            [ M.value_with_ty (M.read (| self |)) (Ty.apply (Ty.path "&") [] [ Ty.path "str" ]) ]
          |)))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
                      ...
                      (M.call_closure (|
                        ...
                        [
                          M.value_with_ty
                            (M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| self |) |) |))
                            (Ty.apply (Ty.path "&") [] [ Ty.path "str" ]);
                          M.value_with_ty (Value.UnicodeChar 10) (Ty.path "char")
                        ]
                      |))
                      (Ty.apply (Ty.path "core::str::iter::SplitInclusive") [] [ Ty.path "char" ]);
                    M.value_with_ty
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          ...
          M.value_with_ty
            ...
            (Ty.path "core::str::iter::LinesAny")))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          ...
          M.value_with_ty
            ...
            (Ty.path "core::str::iter::EncodeUtf16")))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
                                  ...
                                  (M.borrow (|
                                    ...
                                    M.alloc (|
                                      ...
                                      M.call_closure (|
                                        ...
                                        |),
                                        [
                                          M.value_with_ty (M.read (| delimiter |)) P;
                                          M.value_with_ty
                                            (M.borrow (|
                                              Pointer.Kind.Ref,
                                              M.deref (| M.read (| self |) |)
      ...
      | [], [ P ], [ self; prefix ] =>
        ltac:(M.monadic
          ...
          M.call_closure (|
            ...
            |),
            [
              M.value_with_ty (M.read (| prefix |)) P;
              M.value_with_ty
                (M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| self |) |) |))
                (Ty.apply (Ty.path "&") [] [ Ty.path "str" ])
            ]
      ...
      | [], [ P ], [ self; suffix ] =>
        ltac:(M.monadic
          ...
          M.call_closure (|
            ...
            |),
            [
              M.value_with_ty (M.read (| suffix |)) P;
              M.value_with_ty
                (M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| self |) |) |))
                (Ty.apply (Ty.path "&") [] [ Ty.path "str" ])
            ]
