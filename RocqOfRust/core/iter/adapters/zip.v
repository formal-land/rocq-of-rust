            ...
            ltac:(M.monadic
              ...
              M.call_closure (|
                ...
                M.get_trait_method (|
                  ...
                  []
                |),
                [ M.value_with_ty (M.read (| a |)) A; M.value_with_ty (M.read (| b |)) B ]
              |)))
          | _, _, _ => M.impossible "wrong number of arguments"
          end.
                              ...
                              M.read (|
                                let~ lower : Ty.path "usize" :=
                                  M.call_closure (|
                                    ...
                                    [
                                      M.value_with_ty (M.read (| a_lower |)) (Ty.path "usize");
                                      M.value_with_ty (M.read (| b_lower |)) (Ty.path "usize")
                                    ]
                                  |) in
                                let~ upper :
                                    Ty.apply
              ...
              M.read (|
                ...
                let~ len : Ty.path "usize" :=
                  M.call_closure (|
                    ...
                    M.get_function (| "core::cmp::min", [], [ Ty.path "usize" ] |),
                    [
                      M.value_with_ty (M.read (| a_len |)) (Ty.path "usize");
                      M.value_with_ty
                        (M.call_closure (|
                          Ty.path "usize",
                          M.get_trait_method (|
        ...
        | [], [ _ as I ], [ it; idx ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.value_with_ty
                  (M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| it |) |) |))
