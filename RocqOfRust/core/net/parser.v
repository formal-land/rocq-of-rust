                    ...
                    M.match_operator (|
                      ...
                      [
                        fun γ =>
                          ltac:(M.monadic
                            (let _ :=
                              M.is_struct_tuple (| γ, "core::net::parser::AddrKind::Ip" |) in
                            mk_str (| "invalid IP address syntax" |)));
                        fun γ =>
                          ltac:(M.monadic
                            (let _ :=
                              M.is_struct_tuple (| γ, "core::net::parser::AddrKind::Ipv4" |) in
                            M.borrow (|
                              Pointer.Kind.Ref,
                        ...
                        fun γ =>
                          ltac:(M.monadic
                            (let _ :=
                              M.is_struct_tuple (| γ, "core::net::parser::AddrKind::Ipv6" |) in
                            M.borrow (|
                              Pointer.Kind.Ref,
