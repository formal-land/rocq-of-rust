...
#[derive(Clone)]
/// a rocq expression
/// (suitable also for rocq type expressions,
///     because in rocq types are like any other values)
...
#[derive(Clone)]
/// a declaration of an argument of a rocq construction
...
impl TopLevel {
    /// produces a new list of rocq items
    ...
    /// We do so because in Rocq we cannot have two separate modules with the same name.
...
impl Definition {
    /// produces a new rocq definition
